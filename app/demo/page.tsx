...
export default function DemoPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white flex flex-col justify-between p-6 pb-24 md:p-12 md:pb-24">
      {/* Header */}
      <header className="max-w-4xl w-full mx-auto flex justify-between items-center py-4 border-b border-slate-800 mb-6">
      ...
      {/* Standalone Chatbot Section */}
      <section className="max-w-3xl w-full mx-auto my-auto">
        <div className="mb-6 text-center">
          <h1 className="text-3xl font-extrabold mb-2">Live AI Lead Qualifier Sandbox</h1>
          <p className="text-slate-400 text-sm">Experience how PropelRealty AI interacts with buyer and seller leads in real time.</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl flex flex-col h-[520px]">
          <div className="flex items-center gap-3 border-b border-slate-800 pb-4 mb-4">
            ...
            <span className="font-semibold text-sm">Bot Status: Online</span>
          </div>
          ...
          <div className="flex gap-2 pt-4 border-t border-slate-800 mt-2">
            ...
            />
            <button onClick={sendMessage} className="bg-blue-600 hover:bg-blue-500 px-5 py-2 rounded-lg text-sm font-semibold transition">
              Send
            </button>
          </div>
        </div>
